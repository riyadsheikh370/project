  ...
  return (
    ...
    <div className="container mx-auto px-[20px] md:px-[0px]">
        ...
        <div className="ul_box flex justify-between">
            ...
            <ul className='w-[33.3333333%]'>
                ...
                <li className='font-sans text-[16px] font-[400] py-[3px] text-white leading-[23px]'>Category 1</li>
                <li className='font-sans text-[16px] font-[400] py-[3px] text-white leading-[23px]'>Category 2</li>
                <li className='font-sans text-[16px] font-[400] py-[3px] text-white leading-[23px]'>Category 3</li>
                <li className='font-sans text-[16px] font-[400] py-[3px] text-white leading-[23px]'>Category 4</li>
                <li className='font-sans text-[16px] font-[400] py-[3px] text-white leading-[23px]'>Category 5</li>
            </ul>
            <ul className='w-[33.3333333%]'>
    ...
    <div className="w-[100%] flex flex-wrap md:w-[60%]">
        <ul className='w-[100%] md:w-[50%] pt-[0px]'>
            <li className='text-[20px] text-orange-700 font-[700] font-sans'>+880 1813 90 42 57</li>
